...
vvTreeProducer = cfg.Analyzer(
	 ...
	 #"jets"       : NTupleCollection("jet",JetTypeExtra,300, help="all jets in miniaod"),
         ...
         #"jetsAK8"       : NTupleCollection("jetAK8",JetTypeExtra,300, help="all jets in miniaod"),
         "genJetsAK8PFpuppi"   : NTupleCollection("genJetAK8",genJetType,10, mcOnly=True, help="genJets in miniaod"),
         "boostObjsAK8PFpuppi" : NTupleCollection("boostJetAK8",FatJetType,10, help="merged jets with substructures in miniaod"),
