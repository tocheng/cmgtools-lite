...
vvTreeProducer = cfg.Analyzer(
     ...
     collections = {
         ...
         "jets"       : NTupleCollection("jet",JetType,15, help="all jets with new JEC for 76X applied"),
         #"jets_74x"   : NTupleCollection("jet",JetType,15, help="all jets from miniAOD, corrected by 74x jec"),
     }
)
