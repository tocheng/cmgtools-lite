...
jetAna = cfg.Analyzer(
    ...
    jecPath = "${CMSSW_BASE}/src/CMGTools/XZZ2l2nu/data/jec2017/", #${CMSSW_BASE}/src/CMGTools/RootTools/data/jec/
    jerPath = "${CMSSW_BASE}/src/CMGTools/XZZ2l2nu/data/jer2017/", #${CMSSW_BASE}/src/CMGTools/RootTools/data/jec/
