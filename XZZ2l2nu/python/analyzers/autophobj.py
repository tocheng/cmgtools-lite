...
leptonType = NTupleObjectType("lepton", baseObjectTypes = [ particleType ], variables = [
    ...
    NTupleVariable("hltSafeId",   lambda x : x.hltSafeId if abs(x.pdgId())==11 else -999, float, help="hltSafeId"),
    ...
    NTupleVariable("trigerobj_HLTbit", lambda x : x.triggerbit if hasattr(x,'triggerbit')  else -100, int, help="Electron matched HLT object path bit"),
    #NTupleVariable("trigerobj_HLTfilters", lambda x : x.triggerFilters if hasattr(x,'triggerFilters')  else '', string, help="Electron matched HLT object filters"),
    NTupleVariable("isBadMuon", lambda x : x.isBadMuon if hasattr(x,'isBadMuon')  else 0, int, help="flag of bad muon"),
    NTupleVariable("isPFMuon",   lambda x : x.isPFMuon() if (abs(x.pdgId())==13) else -999, float, help="if not pf muon, that is a bad more on duplicated muon"),
])
...
photonType = NTupleObjectType("gamma", baseObjectTypes = [ particleType ], variables = [
    ...
    NTupleVariable("iphi",  lambda x : x.iPhi(), float, help=" "),
    NTupleVariable("e5x5",  lambda x : x.e5x5(), float, help=" "),
    NTupleVariable("e3x3",  lambda x : x.e3x3(), float, help=" "),
    NTupleVariable("e2x5",  lambda x : x.e2x5(), float, help=" "),
    NTupleVariable("e1x5",  lambda x : x.e1x5(), float, help=" "),
    NTupleVariable("eTop",  lambda x : x.eTop(), float, help=" "),
    NTupleVariable("eBottom",  lambda x : x.eBottom(), float, help=" "),
    NTupleVariable("eLeft",  lambda x : x.eLeft(), float, help=" "),
    NTupleVariable("eRight",  lambda x : x.eRight(), float, help=" "),
    NTupleVariable("eMax",  lambda x : x.eMax(), float, help=" "),
    NTupleVariable("time",  lambda x : x.time, float, help="seed xtal time"),
    NTupleVariable("SwissCross",  lambda x : x.SwissCross, float, help="SwissCross"),
    NTupleVariable("r9",  lambda x : x.full5x5_r9(), float, help="r9 for photons"),
    NTupleVariable("mipNhitCone",  lambda x : x.mipNhitCone(), int, help="mipNhitCone"),
    NTupleVariable("mipIsHalo",  lambda x : x.mipIsHalo(), int, help="mipIsHalo"),
    NTupleVariable("mipTotE",  lambda x : x.mipTotEnergy(), float, help="mipTotEnergy"),
    NTupleVariable("sigmaIetaIeta",  lambda x : x.full5x5_sigmaIetaIeta(), float, help="sigmaIetaIeta for photons"),
    NTupleVariable("sigmaIphiIphi",  lambda x : x.full5x5_showerShapeVariables().sigmaIphiIphi, float, help="sigmaIphiIphi for photons"),
...
metType = NTupleObjectType("met", baseObjectTypes = [ fourVectorType ], variables = [
    ...
    NTupleVariable("t1XYPt",  lambda x : x.corPt(ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi",  lambda x : x.corPhi(ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYSumEt",  lambda x : x.corSumEt(ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1SmearPt",  lambda x : x.corPt(ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1SmearPhi",  lambda x : x.corPhi(ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1SmearSumEt",  lambda x : x.corSumEt(ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1Pt_JetEnUp",  lambda x : x.shiftedPt(ROOT.pat.MET.JetEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_JetEnDn",  lambda x : x.shiftedPt(ROOT.pat.MET.JetEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_JetEnUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_JetEnDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_JetResUp",  lambda x : x.shiftedPt(ROOT.pat.MET.JetResUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_JetResDn",  lambda x : x.shiftedPt(ROOT.pat.MET.JetResDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_JetResUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetResUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_JetResDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetResDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_MuonEnUp",  lambda x : x.shiftedPt(ROOT.pat.MET.MuonEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_MuonEnDn",  lambda x : x.shiftedPt(ROOT.pat.MET.MuonEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_MuonEnUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.MuonEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_MuonEnDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.MuonEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_ElectronEnUp",  lambda x : x.shiftedPt(ROOT.pat.MET.ElectronEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_ElectronEnDn",  lambda x : x.shiftedPt(ROOT.pat.MET.ElectronEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_ElectronEnUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.ElectronEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_ElectronEnDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.ElectronEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_TauEnUp",  lambda x : x.shiftedPt(ROOT.pat.MET.TauEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_TauEnDn",  lambda x : x.shiftedPt(ROOT.pat.MET.TauEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_TauEnUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.TauEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_TauEnDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.TauEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_PhotonEnUp",  lambda x : x.shiftedPt(ROOT.pat.MET.PhotonEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_PhotonEnDn",  lambda x : x.shiftedPt(ROOT.pat.MET.PhotonEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_PhotonEnUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.PhotonEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_PhotonEnDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.PhotonEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_NoShift",  lambda x : x.shiftedPt(ROOT.pat.MET.NoShift,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_NoShift",  lambda x : x.shiftedPhi(ROOT.pat.MET.NoShift,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_UnclusterUp",  lambda x : x.shiftedPt(ROOT.pat.MET.UnclusteredEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_UnclusterDn",  lambda x : x.shiftedPt(ROOT.pat.MET.UnclusteredEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_UnclusterUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.UnclusteredEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_UnclusterDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.UnclusteredEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1XYPt_JetEnUp",  lambda x : x.shiftedPt(ROOT.pat.MET.JetEnUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_JetEnDn",  lambda x : x.shiftedPt(ROOT.pat.MET.JetEnDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_JetEnUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetEnUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_JetEnDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetEnDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_JetResUp",  lambda x : x.shiftedPt(ROOT.pat.MET.JetResUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_JetResDn",  lambda x : x.shiftedPt(ROOT.pat.MET.JetResDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_JetResUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetResUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_JetResDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetResDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_MuonEnUp",  lambda x : x.shiftedPt(ROOT.pat.MET.MuonEnUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_MuonEnDn",  lambda x : x.shiftedPt(ROOT.pat.MET.MuonEnDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_MuonEnUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.MuonEnUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_MuonEnDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.MuonEnDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_ElectronEnUp",  lambda x : x.shiftedPt(ROOT.pat.MET.ElectronEnUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_ElectronEnDn",  lambda x : x.shiftedPt(ROOT.pat.MET.ElectronEnDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_ElectronEnUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.ElectronEnUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_ElectronEnDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.ElectronEnDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_TauEnUp",  lambda x : x.shiftedPt(ROOT.pat.MET.TauEnUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_TauEnDn",  lambda x : x.shiftedPt(ROOT.pat.MET.TauEnDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_TauEnUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.TauEnUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_TauEnDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.TauEnDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_PhotonEnUp",  lambda x : x.shiftedPt(ROOT.pat.MET.PhotonEnUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_PhotonEnDn",  lambda x : x.shiftedPt(ROOT.pat.MET.PhotonEnDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_PhotonEnUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.PhotonEnUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_PhotonEnDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.PhotonEnDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_NoShift",  lambda x : x.shiftedPt(ROOT.pat.MET.NoShift,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_NoShift",  lambda x : x.shiftedPhi(ROOT.pat.MET.NoShift,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_UnclusterUp",  lambda x : x.shiftedPt(ROOT.pat.MET.UnclusteredEnUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPt_UnclusterDn",  lambda x : x.shiftedPt(ROOT.pat.MET.UnclusteredEnDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_UnclusterUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.UnclusteredEnUp,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1XYPhi_UnclusterDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.UnclusteredEnDown,ROOT.pat.MET.Type1XY) ),
    NTupleVariable("t1SmearPt_JECUp",  lambda x : x.shiftedPt(ROOT.pat.MET.JetEnUp,ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1SmearPt_JECDn",  lambda x : x.shiftedPt(ROOT.pat.MET.JetEnDown,ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1SmearPhi_JECUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetEnUp,ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1SmearPhi_JECDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetEnDown,ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1SmearPt_JERUp",  lambda x : x.shiftedPt(ROOT.pat.MET.JetResUp,ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1SmearPt_JERDn",  lambda x : x.shiftedPt(ROOT.pat.MET.JetResDown,ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1SmearPhi_JERUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetResUp,ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1SmearPhi_JERDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetResDown,ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1SmearPt_UnclusterUp",  lambda x : x.shiftedPt(ROOT.pat.MET.UnclusteredEnUp,ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1SmearPt_UnclusterDn",  lambda x : x.shiftedPt(ROOT.pat.MET.UnclusteredEnDown,ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1SmearPhi_UnclusterUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.UnclusteredEnUp,ROOT.pat.MET.Type1Smear) ),
    NTupleVariable("t1SmearPhi_UnclusterDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.UnclusteredEnDown,ROOT.pat.MET.Type1Smear) ),
