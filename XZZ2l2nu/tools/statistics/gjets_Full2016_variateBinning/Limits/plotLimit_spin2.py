...
def plotLimit(parser):
    ...
    for m in mH:
      ...
      f = TFile("Datacards/gjet_"+cut+"_Graviton2PB_width0/higgsCombineTest.Asymptotic.mH"+str(m)+".root","READ")
      t = f.Get("limit")
      ...
      f = TFile("Datacards/gjet_"+cut+"_Graviton2PB_width0p1/higgsCombineTest.Asymptotic.mH"+str(m)+".root","READ")
      t = f.Get("limit")
      ...
      f = TFile("Datacards/gjet_"+cut+"_Graviton2PB_width0p2/higgsCombineTest.Asymptotic.mH"+str(m)+".root","READ")
      t = f.Get("limit")
      ...
      f = TFile("Datacards/gjet_"+cut+"_Graviton2PB_width0p3/higgsCombineTest.Asymptotic.mH"+str(m)+".root","READ")
      t = f.Get("limit")
    ...
    legend.AddEntry(gr_exp_0p1 , "Expected 95% CL Graviton2PB 0.1 width", "l")
    legend.AddEntry(gr_exp_0p2 , "Expected 95% CL Graviton2PB 0.2 width", "l")
    legend.AddEntry(gr_exp_0p3 , "Expected 95% CL Graviton2PB 0.3 width", "l")
    ...
    c.SaveAs("xzz2l2nu_limit_13TeV_channel_SR_bin"+str(bin_index)+"_Graviton2PB.pdf")
    c.SaveAs("xzz2l2nu_limit_13TeV_channel_SR_bin"+str(bin_index)+"_Graviton2PB.png")
