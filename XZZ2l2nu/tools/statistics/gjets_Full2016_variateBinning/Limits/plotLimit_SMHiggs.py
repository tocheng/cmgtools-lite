...
def plotLimit(parser):
    ...
    mH = [200,300,400,500,600,700,800,900,1000,1500,2000,2500]
    for m in mH:
      ...
      f = TFile("Datacards/gjet_"+cut+"_ggH/higgsCombineTest.Asymptotic.mH"+str(m)+".root","READ")
      t = f.Get("limit")
      ...
      f = TFile("Datacards/gjet_"+cut+"_VBF/higgsCombineTest.Asymptotic.mH"+str(m)+".root","READ")
      t = f.Get("limit")
    ...
    legend.AddEntry(sigXsec , "100% VBF production", "l")
