...
TFile* file=TFile::Open("plot_mlfit_mt_shapes_fit_b_ee_SR_False.root");
...
dummyR->GetYaxis()->SetNdivisions(505,kTRUE);
dummyR->GetYaxis()->SetRangeUser(0.01,1.99);
dummyR->GetYaxis()->SetLabelSize(0.03);
dummyR->GetXaxis()->SetLabelSize(0.05);
//dummyR->GetXaxis()->SetTitleSize(0.06);
dummyR->GetXaxis()->SetTitle("m_{T} (GeV)");



gr_data->SetPointEYlow(15,0);
gr_data->SetPointEYhigh(15,1.84105);
gr_data->SetPointEYlow(17,0);
gr_data->SetPointEYhigh(17,1.84105);
...
pavetext_channel->AddText("ee channel");
...
plots->SaveAs("updated_mt_ee.pdf");
}
