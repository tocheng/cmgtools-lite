...
TFile* file=TFile::Open("PAS1_ReMiniSummer16_DT_PhReMiniMCRcFixXsec_GMCPhPtWt_SRdPhiGT0p5_puWeightsummer16_muoneg_gjet_metfilter_unblind_mu_log_1pb.root");
...
zpt_pavetext_channel->AddText("#mu#mu channel");
...
zpt_c1->SaveAs("updated_zpt_mm.pdf");
