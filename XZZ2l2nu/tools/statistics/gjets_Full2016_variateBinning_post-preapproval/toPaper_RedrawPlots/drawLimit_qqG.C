...
TFile* file=TFile::Open("ReMiniAODCRScaleMoreSig_xzz2l2nu_limit_13TeV_SRdPhiGT0p5_qqG_unblind.root");
...
((TLegendEntry*)legend0->GetListOfPrimitives()->At(0))->SetLabel("95% CL upper limits: qqX");
...
c->SaveAs("updated_Limits_qqG.pdf");
