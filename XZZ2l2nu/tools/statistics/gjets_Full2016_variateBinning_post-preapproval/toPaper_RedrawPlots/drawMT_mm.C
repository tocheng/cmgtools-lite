...
TFile* file=TFile::Open("plot_mlfit_mt_shapes_fit_b_mm_SR_False.root");
...
gr_data->SetPointEYlow(14,0);
gr_data->SetPointEYhigh(14,1.84105);
...
plots->SaveAs("updated_mt_mm.pdf");
}
