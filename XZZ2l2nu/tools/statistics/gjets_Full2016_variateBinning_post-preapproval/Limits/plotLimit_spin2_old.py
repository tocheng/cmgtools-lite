...
def plotLimit(parser):
    ...
    legend.AddEntry(gr_exp_0p1 , "Expected 95% CL Graviton2PB width = 0.1#timesm_{X}", "l")
    legend.AddEntry(gr_exp_0p2 , "Expected 95% CL Graviton2PB width = 0.2#timesm_{X}", "l")
    legend.AddEntry(gr_exp_0p3 , "Expected 95% CL Graviton2PB width = 0.3#timesm_{X}", "l")
    ...
    c.SaveAs("xzz2l2nu_limit_13TeV_channel_SR_Graviton2PB.pdf")
    c.SaveAs("xzz2l2nu_limit_13TeV_channel_SR_Graviton2PB.png")
