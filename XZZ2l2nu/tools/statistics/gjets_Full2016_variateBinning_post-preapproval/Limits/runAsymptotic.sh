...
#   combine -n mm_SR -m ${mH} -M Asymptotic mX${mH}ZZ2l2nu_mm_SR.txt --run blind --rMax 10 --noFitAsimov
   ...
   combine -m ${mH} -M Asymptotic mX${mH}ZZ2l2nu_SR.txt --rMax 10 --noFitAsimov
   combine -n ee_SR -m ${mH} -M Asymptotic mX${mH}ZZ2l2nu_ee_SR.txt --rMax 10 --noFitAsimov
   combine -n mm_SR -m ${mH} -M Asymptotic mX${mH}ZZ2l2nu_mm_SR.txt --rMax 10 --noFitAsimov
