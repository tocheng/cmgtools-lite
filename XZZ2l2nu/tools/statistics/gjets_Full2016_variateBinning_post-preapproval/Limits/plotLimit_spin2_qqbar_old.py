...
def plotLimit(parser):
    ...
    dummy = TH1D("dummy","dummy", 1, 500,2000)
    ...
    legend.AddEntry(gr_exp , "Expected 95% CL q#bar{q}Graviton2PB zero width", "l")
    legend.AddEntry(gr_exp1 , "#pm 1#sigma", "f")
    legend.AddEntry(gr_exp2 , "#pm 2#sigma", "f")
    legend.AddEntry(gr_exp_0p1 , "Expected 95% CL q#bar{q}Graviton2PB width = 0.1#times m_{X}", "l")
    legend.AddEntry(gr_exp_0p2 , "Expected 95% CL q#bar{q}Graviton2PB width = 0.2#times m_{X}", "l")
    legend.AddEntry(gr_exp_0p3 , "Expected 95% CL q#bar{q}Graviton2PB width = 0.3#times m_{X}", "l")
    ...
    c.SaveAs("xzz2l2nu_limit_13TeV_channel_SR_Graviton2PBqqbar.pdf")
    c.SaveAs("xzz2l2nu_limit_13TeV_channel_SR_Graviton2PBqqbar.png")
