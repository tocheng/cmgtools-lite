{
  ...
  TFile* file1 = TFile::Open("eff_out_ell1pteta_36p46recalib.root");
  ...
  std::string  lumiTag = "CMS 13 TeV 2016 L=36.46 fb^{-1}";
  ...
  lumipt->Draw();
  plots->SaveAs("trigeff36p46_el_pt120to1k.pdf");

  plots->Clear();
  h2d1->GetXaxis()->SetRangeUser(90,120);
  h2d1->Draw("colz text45");
  lumipt->Draw();
  plots->SaveAs("trigeff36p46_el_pt90to120.pdf");
