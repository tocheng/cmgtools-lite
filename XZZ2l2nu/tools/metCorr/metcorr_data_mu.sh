...
#inputs
inputdir=/eos/user/t/tocheng/X2l+MET+jets/Run2016/SingleMuon
outputdir=/eos/user/t/tocheng/X2l+MET+jets/Run2016/Analysis/ZJetsPreskim
...
for infile in $(ls $inputdir/*.root | grep SingleMuon ); 
do
