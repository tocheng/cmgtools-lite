...
*/
  ...
  //
  Double_t ZPtWeight, ZPtWeightUp, ZPtWeightDn, ZPtWeightErr;
  TBranch *b_ZPtWeight=tree_out->Branch("ZPtWeight",&ZPtWeight,"ZPtWeight/D");
  TBranch *b_ZPtWeightUp=tree_out->Branch("ZPtWeightUp",&ZPtWeightUp,"ZPtWeightUp/D");
  TBranch *b_ZPtWeightDn=tree_out->Branch("ZPtWeightDn",&ZPtWeightDn,"ZPtWeightDn/D");

  Double_t PhiStarWeight, PhiStarWeightUp, PhiStarWeightDn, PhiStarWeightErr;
  TBranch *b_PhiStarWeight=tree_out->Branch("PhiStarWeight",&PhiStarWeight,"PhiStarWeight/D");
  TBranch *b_PhiStarWeightUp=tree_out->Branch("PhiStarWeightUp",&PhiStarWeightUp,"PhiStarWeightUp/D");
  TBranch *b_PhiStarWeightDn=tree_out->Branch("PhiStarWeightDn",&PhiStarWeightDn,"PhiStarWeightDn/D");
...
*/
  ...
  //for (int i=0; i<10000; i++){
    ...
    ZPtWeightErr = hdyzpt_dtmc_ratio->GetBinError(hdyzpt_dtmc_ratio->FindBin(genZ_pt[0]));
    ZPtWeightUp = ZPtWeight + ZPtWeightErr/2.0; 
    ZPtWeightDn = ZPtWeight - ZPtWeightErr/2.0; 
    ...
    PhiStarWeightErr = hdyphistar_dtmc_ratio->GetBinError(hdyphistar_dtmc_ratio->FindBin(phistar));
    PhiStarWeightUp = PhiStarWeight + PhiStarWeightErr/2.0;
    PhiStarWeightDn = PhiStarWeight - PhiStarWeightErr/2.0;
