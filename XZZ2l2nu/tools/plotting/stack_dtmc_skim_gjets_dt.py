...
#cuts_lepaccept="((abs(llnunu_l1_l1_pdgId)==13&&abs(llnunu_l1_l2_pdgId)==13&&llnunu_l1_l1_pt>20&&abs(llnunu_l1_l1_eta)<2.4&&llnunu_l1_l2_pt>20&&abs(llnunu_l1_l2_eta)<2.4&&(llnunu_l1_l1_highPtID>0.99||llnunu_l1_l2_highPtID>0.99)&&llnunu_l1_pt>100)"
#cuts_lepaccept+="||(abs(llnunu_l1_l1_pdgId)==11&&abs(llnunu_l1_l2_pdgId)==11&&llnunu_l1_l1_pt>25&&abs(llnunu_l1_l1_eta)<2.5&&llnunu_l1_l2_pt>25&&abs(llnunu_l1_l2_eta)<2.5&&llnunu_l1_pt>100)"
...
for sample in phymetSamples:
    ...
    if channel=='el' :
        ...
        phymetPlotters[-1].addCorrectionFactor('(1.02585)','GJetsNorm')
    elif channel=='mu' :
        ...
        phymetPlotters[-1].addCorrectionFactor('(1.11636)','GJetsNorm')
    else :
...
#    Stack.drawStack('llnunu_l2_pt_to_plot', cuts, str(lumi*1000), 50, 0, 500, titlex = "MET", units = "GeV",output=tag+'met_low',outDir=outdir,separateSignal=sepSig,blinding=Blind,blindingCut=200)
    Stack.drawStack('llnunu_l2_pt_to_plot', cuts, str(lumi*1000), 20, 0, 1000, titlex = "MET", units = "GeV",output=tag+'met',outDir=outdir,separateSignal=sepSig,blinding=Blind,blindingCut=200)
